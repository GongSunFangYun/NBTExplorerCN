    ...
    public partial class HexEditor : Form
    {
        ...
        private class HexView : EditView
        {
            ...
            public override void Initialize ()
            {
                ...
                _hexBox.InsertActiveChanged += (s, e) => { _insertLabel.Text = (_hexBox.InsertActive) ? "插入模式" : "覆盖模式"; };
            ...
            private void InitializeStatusBar ()
            {
                ...
                _insertLabel = new ToolStripStatusLabel() {
                    Size = new Size(58, 17),
                    Text = (_hexBox.InsertActive) ? "插入模式" : "覆盖模式",
                };
            }
        ...
        private void ExportRaw (string path)
        {
            try {
                ...
                MessageBox.Show("将数据导出至 \"" + path + "\" 失败！\n原因: " + e.Message);
            }
        }
