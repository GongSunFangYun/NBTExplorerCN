namespace NBTExplorer.Windows
{
    partial class FindReplace
    {
        ...
        private void InitializeComponent ()
        {
            ...
            this._tbFindDelete.Text = "删除选择的规则";
            ...
            this._tbFindGroupAnd.Text = "添加全部匹配组";
            ...
            this._tbFindGroupOr.Text = "添加任意匹配组";
            ...
            this._tbFindAny.Text = "添加任意类型标签规则";
            ...
            this._tbFindByte.Text = "添加字节标签规则[Byte]";
            ...
            this._tbFindShort.Text = "添加短标签规则[Short]";
            ...
            this._tbFindInt.Text = "添加整数标签规则[Int]";
            ...
            this._tbFindLong.Text = "添加长标签规则[Long]";
            ...
            this._tbFindFloat.Text = "添加浮点数标签规则[Float]";
            ...
            this._tbFindDouble.Text = "添加双精度浮点数标签规则[Double]";
            ...
            this._tbFindString.Text = "添加文本标签规则[Text]";
            ...
            this._deleteTagsCheckbox.Text = "在应用替换之前删除匹配的标签.";
            ...
            this._tbReplaceEdit.Text = "编辑选取的标签";
            ...
            this._tbReplaceDelete.Text = "删除选取的标签";
            ...
            this._tbReplaceByte.Text = "添加字节标签[Byte]";
            ...
            this._tbReplaceShort.Text = "添加短标签[Short]";
            ...
            this._tbReplaceInt.Text = "添加整数标签[Int]";
            ...
            this._tbReplaceLong.Text = "添加长标签[Long]";
            ...
            this._tbReplaceFloat.Text = "添加浮点数标签[Float]";
            ...
            this._tbReplaceDouble.Text = "添加双精度浮点数标签[Double]";
            ...
            this._tbReplaceByteArray.Text = "添加字节数组标签[Byte Array]";
            ...
            this._tbReplaceIntArray.Text = "添加整数数组标签[Int Array]";
            ...
            this._tbReplaceLongArray.Text = "添加长数组标签[Long Array]";
            ...
            this._tbReplaceString.Text = "添加字符串标签[String]";
            ...
            this._tbReplaceList.Text = "添加列表标签[List]";
            ...
            this._tbReplaceCompound.Text = "添加复合标签[Compound Tag]";
            ...
            this._buttonReplaceAll.Text = "替换全部";
